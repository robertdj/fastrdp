...
To illustrate how *fastrdp* scales with the number of observations consider the following graph.
This is for random input and it is expected that the output has a size similar to the output. 
...
However, to control compilation of the C++ code a legacy `setup.py` is used.
